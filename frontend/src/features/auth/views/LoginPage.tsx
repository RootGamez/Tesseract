            ...
            <CardContent className="pt-6 space-y-5">
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="email" type="email" placeholder="tu@correo.com" {...form.register('email')} className="h-11" />
                ...
                <Button type="submit" className="w-full h-11 text-base font-semibold sidebar-gradient border-0 text-white hover:opacity-90" disabled={isLoading}>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-card px-2 text-muted-foreground">acceso demo</span>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-3">
                <Button variant="outline" size="sm" className="text-xs" onClick={() => { form.setValue('email', 'instructor@tesseract.com'); form.setValue('password', 'demo12345'); }}>
                  Demo Instructor
                </Button>
                <Button variant="outline" size="sm" className="text-xs" onClick={() => { form.setValue('email', 'student@tesseract.com'); form.setValue('password', 'demo12345'); }}>
                  Demo Estudiante
                </Button>
              </div>
            </CardContent>
